...
object ScoutingService {
    ...
    fun updateEntry(
        ...
        return transaction {
            val row = ScoutingEntries.selectAll().where { ScoutingEntries.id eq entryId }.firstOrNull()
            ...
            val updatedRow = ScoutingEntries.selectAll().where { ScoutingEntries.id eq entryId }.first()
